 ...
 options:{
   ...
   else if(this.dateFrom!="" && this.dateTo=="")
   {
      ...
      if(this.selectedValue.length==1 ){
       ...
       this.http.get("http://127.0.0.1:8000/api/pingOneData"+"/"+this.dateFrom+"/"+this.selectedValue)
       .subscribe((resultData: any)=>
       {
        //this.isResultLoaded=true;
        console.log(resultData);
   ...
   options:{
     ...
     //maintainAspectRatio: false
      ...
      for(let i=0;i<this.selectedValue.length;i++)
      {
       this.http.get("http://127.0.0.1:8000/api/pingOneData"+"/"+this.dateFrom+"/"+this.selectedValue[i])
     .subscribe((resultData: any)=>
     {
      //this.isResultLoaded=true;
      console.log(resultData);
 ...
 options:{
   ...
   else if(this.dateFrom=="" && this.dateTo!="")
   {
      ...
      if(this.selectedValue.length==1 ){
       ...
       this.http.get("http://127.0.0.1:8000/api/pingOneData"+"/"+this.dateTo+"/"+this.selectedValue)
       .subscribe((resultData: any)=>
       {
        //this.isResultLoaded=true;
        console.log(resultData);
   ...
   options:{
     ...
     //maintainAspectRatio: false
      ...
      for(let i=0;i<this.selectedValue.length;i++)
      {
       this.http.get("http://127.0.0.1:8000/api/pingOneData"+"/"+this.dateTo+"/"+this.selectedValue[i])
     .subscribe((resultData: any)=>
     {
      //this.isResultLoaded=true;
      console.log(resultData);
 ...
 options:{
  ...
  else if(this.selectedValue.length==0)
  {
    if(this.dateFrom!="" && this.dateTo!=""){
      ...
      console.log(this.selectedValue);
      let myChart:any=[];   
       this.http.get("http://127.0.0.1:8000/api/pingData1"+"/"+this.dateFrom+"/"+this.dateTo)
       .subscribe((resultData: any)=>
       {
        //this.isResultLoaded=true;
        console.log(resultData);
        ...
        console.log(this.PingArray);
        if (this.PingArray.length === 0) {
          this.errorMessage = "Aucun ping trouvé entre "+this.dateFrom+" et "+this.dateTo;
        } else {
          this.errorMessage = "";
        }
       console.log(this.errorMessage);
   ...
   options:{
    ...
    else if(this.dateFrom!="" && this.dateTo=="")
    {
       ...
       console.log(this.selectedValue);
       let myChart:any=[];
        this.http.get("http://127.0.0.1:8000/api/pingOneData1"+"/"+this.dateFrom)
        .subscribe((resultData: any)=>
        {
         //this.isResultLoaded=true;
         console.log(resultData);
   ...
   else if(this.dateFrom=="" && this.dateTo!="")
   {
      ...
      console.log(this.selectedValue);
      let myChart:any=[];    
       this.http.get("http://127.0.0.1:8000/api/pingOneData1"+"/"+this.dateTo)
       .subscribe((resultData: any)=>
       {
        //this.isResultLoaded=true;
        console.log(resultData);
